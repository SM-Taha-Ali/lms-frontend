...
const EmpReg = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await regEmployee(employeeReg.inquiry, employeeReg.gr_no, employeeReg.join_date, employeeReg.jobType, employeeReg.dept, employeeReg.designation,
      ...
      employeeReg.no_of_children, employeeReg.family_members, employeeReg.curr_addr, employeeReg.perm_addr, employeeReg.country, employeeReg.state, employeeReg.city,
